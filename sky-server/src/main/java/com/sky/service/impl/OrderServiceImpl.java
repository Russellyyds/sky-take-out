...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        if (addressBook == null) {
            throw new IllegalStateException(MessageConstant.ADDRESS_BOOK_IS_NULL);
        }
        ...
        if (shoppingCartListlist == null || shoppingCartListlist.size() == 0) {
            throw new IllegalStateException(MessageConstant.SHOPPING_CART_IS_NULL);
        }
        //向订单表插入一条数据
...
//        return vo;
    ...
    public void paySuccess(String outTradeNo) {
        Long currentId = BaseContext.getCurrentId();
        // 根据订单号查询订单
        Orders ordersDB = orderMapper.getByNumberAndUserId(outTradeNo,currentId);
